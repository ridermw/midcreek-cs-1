...
use midcreek_cs_1::{
    ...
    design::{
        ...
        KEY_ART_REFERENCE_PATH, MAX_ACTIVE_TICKETS, MIN_AISLE_CLEARANCE, ORTHOGRAPHIC_HEIGHT,
        ORTHOGRAPHIC_WIDTH, OVERHEAD_TRAY_HEIGHT, PLAYER_RADIUS, PLAYER_SPEED, PaletteRole,
...
fn design_references_match_the_approved_pngs() {
    ...
    let references = [
        (
            ...
            approved_reference_sha256(KEY_ART_REFERENCE_PATH),
            image::ImageFormat::Png,
        ),
        (
            CHARACTER_SHEET_REFERENCE_PATH,
            approved_reference_sha256(CHARACTER_SHEET_REFERENCE_PATH),
            image::ImageFormat::Png,
        ),
    ];
